...
class KiteExt(KiteConnect):
    def login_with_credentials(self, userid, password, pin):
        ...
        # Print the enctoken after login
    ...
    def __init__(self, api_key="2b0bx36bnep2vslf", userid=None, *args, **kw):
    ...
    def kws(self, api_key="2b0bx36bnep2vslf"):
    ...
    def ticker(self, api_key="2b0bx36bnep2vslf", enctoken=None, userid=None):
